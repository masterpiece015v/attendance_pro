...
import tokyo.mstp015v.attendance.databinding.FragmentEnterTimeTableDay2Binding
...
class EnterTimeTableDay2Fragment(var g_name:String,
    ...
    override fun onResume() {
        ...
        ret.forEach {db->
            ...
            //Log.d("ymd","${year} ${month} ${date} ${db.timed} ${day}")
            //Log.d("list",list.toString())
            //Log.d( "hantei" , ("${year}${month}${date}${db.timed}" in list).toString() )
